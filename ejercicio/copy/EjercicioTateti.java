 ...
 *    |   | 
 *    bugs:
 *    1 contador de turnos no hace bien, empezar con jugador 1
 *    2. ficha no es valida saltea jugada...
 *    3. falta validacion de coordenadas
 *    
 */
...
public class EjercicioTateti {
	...
	public static void main(String[] args) {
		char[][] tablero = inicializarMatriz(FILAS, COLS);
...
//				ganador = jugarFicha(turno, tablero);
	...
	private static char[][] inicializarMatriz(int fILAS2, int cOLS2) {
