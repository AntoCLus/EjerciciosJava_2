...
public class TatetiTati {
	...
	private static boolean isWinner(String tablero[][]) {
		...
		boolean hor1 = (tablero[0][0] == tablero[0][1] && tablero[0][0] == tablero[0][2]
				&& (tablero[0][0] == " X " || tablero[0][0] == " O "));
		boolean hor2 = (tablero[1][0] == tablero[1][1] && tablero[1][0] == tablero[1][2]
				&& (tablero[1][0] == " X " || tablero[1][0] == " O "));
		boolean hor3 = (tablero[2][0] == tablero[2][1] && tablero[2][0] == tablero[2][2]
				&& (tablero[2][0] == " X " || tablero[2][0] == " O "));
		boolean ver1 = (tablero[0][0] == tablero[1][0] && tablero[0][0] == tablero[2][0]
				&& (tablero[0][0] == " X " || tablero[0][0] == " O "));
		boolean ver2 = (tablero[0][1] == tablero[1][1] && tablero[0][1] == tablero[2][1]
				&& (tablero[0][1] == " X " || tablero[0][1] == " O "));
		boolean ver3 = (tablero[0][2] == tablero[1][2] && tablero[0][2] == tablero[2][2]
				&& (tablero[0][2] == " X " || tablero[0][2] == " O "));
		boolean dia1 = (tablero[0][0] == tablero[1][1] && tablero[0][0] == tablero[2][2]
				&& (tablero[0][0] == " X " || tablero[0][0] == " O "));
		boolean dia2 = (tablero[0][2] == tablero[1][1] && tablero[0][2] == tablero[2][0]
				&& (tablero[0][2] == " X " || tablero[0][2] == " O "));
